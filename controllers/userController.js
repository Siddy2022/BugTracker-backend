            ...
            UserModel.updateOne({ 'email': req.body.email }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: 'Reset Password for BugTracker ',
                        html: `
                        <!doctype html>
                        <html>
                        <head>
                        ...
                        p{
                            ...
                            <p>
                                We got a request to reset your BugTracker app password associated with this ${req.body.email} Email. <br>
        ...
        return new Promise((resolve, reject) => {
            ...
            UserModel.updateOne({ 'userId': userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        email: userDetails.email,
                        subject: 'Password Updated for BugTracker ',
                        html: `<h4> Hi ${userDetails.firstName}</h4>
                        <p>
                            Password updated successfully.
                        </p>
                        <h3> Thanks for using BugTracker </h3>
                        Regards
                        <br><b>Siddharth Singh </b>
                                    `
                    }
