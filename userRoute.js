...
let setRouter=(app) => {
  ...
  app.post(`${baseUrl}/signup`, userController.signUpFunction);
     ...
     * @apiGroup Users
     * @apiVersion  1.0.0
     * @api {post} http://api.bugtracker.gq/api/v1/users/signup To Signup user.
     *
  ...
  app.post(`${baseUrl}/login`, userController.loginFunction);
    ...
    /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {post} http://api.bugtracker.gq/api/v1/users/login Login.
         *
  ...
  /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {get}  http://api.bugtracker.gq/api/v1/users/all To get All users
         *
         *
         * @apiSuccess {object} myResponse shows error status, message, http status code, result.
         * 
  ...
  /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {get}  http://api.bugtracker.gq/api/v1/users/view/:userId To get details of user
         *
         *
         * @apiSuccess {object} myResponse shows error status, message, http status code, result.
         * 
  ...
  /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {put}  http://api.bugtracker.gq/api/v1/users/:userId/delete To delete single user.
         *
  ...
  /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {post}  http://api.bugtracker.gq/api/v1/users/logout Logout.
         *
         *
         * @apiSuccess {object} myResponse shows error status, message, http status code, result.
         * 
    ...
    * @apiGroup users
    * @apiVersion  1.0.0
    * @api {post}  http://api.bugtracker.gq/api/v1/users/recovery-password api for Password Reset.
    *
    * @apiParam {string} email email of the user. (body params) (required)
    *
    * @apiSuccess {object} myResponse shows error status, message, http status code, result.
 ...
 /**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post}  http://api.bugtracker.gq/api/v1/users/update-password api for Updating Password after Reset.
     *
